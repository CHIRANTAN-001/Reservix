"""changed name of composite key

Revision ID: 3f9df0a67ad1
Revises: 0ec8a3f9dedb
Create Date: 2026-02-16 19:14:18.523396
...
revision: str = '3f9df0a67ad1'
down_revision: Union[str, Sequence[str], None] = '0ec8a3f9dedb'
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('country_code', 'phone_number', name='uq_otp_country_phone')
    )
